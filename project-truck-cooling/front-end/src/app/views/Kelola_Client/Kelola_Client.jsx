                ...
                <Stack spacing={2}>
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      sx={{ width: 500 }}
                      {...register("nama_client", { required: true })}
                      error={!!errors.nama_client}
                      helperText={
                        errors.nama_client ? "Nama Klien diperlukan" : ""
                      }
                    />
                  </Stack>
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      sx={{ width: 500 }}
                      {...register("alamat_client", { required: true })}
                      error={!!errors.nama_client}
                      helperText={
                        errors.nama_client ? "Nama Klien diperlukan" : ""
                      }
                  ...
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    {loadingKabupatenKota ? (
                      ...
                      <Autocomplete
                        ...
                        getOptionLabel={(option) => option.kabupaten_kota}
                        value={kota}
                  ...
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <TextField
                      ...
                      helperText={errors.kode_pos ? "Kode Pos diperlukan" : ""}
                    />
                  </Stack>
                  ...
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <TextField
                      ...
                      error={!!errors.no_hp}
                      helperText={errors.no_hp ? "Nomor Kontak diperlukan" : ""}
                    />
                  </Stack>
                  ...
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <TextField
                      ...
                      sx={{ width: 500 }}
                      {...register("tgl_bergabung", { required: true })}
                    />
                  </Stack>
                </Stack>
                <Stack
                              ...
                              <Stack spacing={2}>
                                ...
                                >
                                  ...
                                  <TextField
                                    label="Nama Klien"
                                    variant="outlined"
                                    value={dataSingleClient.nama_client}
                                ...
                                >
                                  ...
                                  <TextField
                                    label="Alamat"
                                    variant="outlined"
                                    value={dataSingleClient.alamat_client}
                                    InputProps={{ readOnly: true }}
                                    sx={{ width: 500 }}
                                  />
                                </Stack>
                                ...
                                >
                                  ...
                                  <TextField
                                    label="Alamat"
                                    variant="outlined"
                                    value={dataSingleClient.kabupaten_kota}
                                    InputProps={{ readOnly: true }}
                                    sx={{ width: 500 }}
                                  />
                                </Stack>
                                ...
                                >
                                  ...
                                  <TextField
                                    label="Tanggal Bergabung"
                                    value={dataSingleClient.tgl_bergabung}
                                    InputProps={{ readOnly: true }}
                                    sx={{ width: 500 }}
                                  />
                                </Stack>
